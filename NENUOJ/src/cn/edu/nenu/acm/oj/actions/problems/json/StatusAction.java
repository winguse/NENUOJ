...
public class StatusAction extends AbstractJsonAction implements SessionAware {
	...
	public String execute() throws Exception {
		code = 0;
		message = "success";
		Pair<Long, List<SolutionSimpleDTO>> result = dao.getSolutionList(
				username, language, judgerSource, problemNumber, statusCode,
				page, pageSize, orderByIndex, includeCurrentContest);
		...
		if ("".equals(judgerSource) && "".equals(username)
				&& "".equals(language) && "".equals(problemNumber)
				&& statusCode == 0) {
