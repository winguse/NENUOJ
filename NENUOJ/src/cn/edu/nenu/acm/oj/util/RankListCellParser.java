...
public class RankListCellParser {
	 ...
	 */
	static {
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { {} }, "No submisson") {
			public long[] getInfo(Integer val[], long contestLength) {
				return new long[] { contestLength, 0, 0 };
			}
		});// 1

		rankListCellExpressions.add(new RankListCellExpression(new long[][] { {} },
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE } },
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 } },
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0, Long.MAX_VALUE } }, "Solved at $1 minute with $2 submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0, Long.MAX_VALUE } }, "Solved at $1 minute with $2 wrong submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0, Long.MAX_VALUE } }, "Solved at $2 minute with $1 submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0, Long.MAX_VALUE } }, "Solved at $2 minute with $1 wrong submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 },
				{ 0, 59 } }, "Solved at $1 hour $2 minute $3 second with no wrong submission") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 },
				{ 0, Long.MAX_VALUE } }, "Solved at $1 hour $2 minute with $3 submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 },
				{ 0, Long.MAX_VALUE } }, "Solved at $1 hour $2 minute with $3 wrong submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
				return new long[] { val[0] * 3600000L + val[1] * 60000L, val[2] + 1, 1 };
			}
		});// 13

		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0, Long.MAX_VALUE },
				{ 0L, Long.MAX_VALUE }, { 0, 59 } }, "Solved at $2 hour $3 minute with $1 submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0, Long.MAX_VALUE }, { 0, 59 } }, "Solved at $2 hour $3 minute with $1 wrong submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 },
				{ 0, 59 }, { 0, Long.MAX_VALUE } }, "Solved at $1 hour $2 minute $3 second with $4 submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
				return new long[] { val[0] * 3600000L + val[1] * 60000L + val[2] * 1000L, val[3], 1 };
			}
		});// 16

		rankListCellExpressions
				.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 }, { 0, 59 },
						{ 0, Long.MAX_VALUE } }, "Solved at $1 hour $2 minute $3 second with $4 wrong submission(s)") {
					public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0, Long.MAX_VALUE } }, "Not solved, with $1 wrong submissions, the last one at $2 minute") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0, Long.MAX_VALUE } }, "Not solved, with $2 wrong submissions, the last one at $1 minute") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 },
				{ 0, Long.MAX_VALUE } }, "Not solved, with $3 wrong submissions, the last one at $1 hour $2 minute") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 },
				{ 0L, Long.MAX_VALUE } }, "Solved at $1 minute $2 second with $3 submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 },
				{ 0L, Long.MAX_VALUE } }, "Solved at $1 minute $2 second with $3 wrong submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0L, Long.MAX_VALUE }, { 0, 59 } }, "Solved at $2 minute $3 second with $1 submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE },
				{ 0L, Long.MAX_VALUE }, { 0, 59 } }, "Solved at $2 minute $3 second with $1 wrong submission(s)") {
			public long[] getInfo(Integer val[], long contestLength) {
		...
		rankListCellExpressions
				.add(new RankListCellExpression(new long[][] { { 0L, Long.MAX_VALUE }, { 0, 59 },
						{ 0L, Long.MAX_VALUE } },
	...
	/**
	 * recognize the cellString, find if exist a pattern previous, or new a
	 * pattern of it.
	 * 
	 * @param cellString
	 */
	public void recognize(String cellString) {
		if ("".equals(cellString))
			return;
		String patternString = getPattern(cellString.trim());
		List<Integer> values = getValues(cellString.trim());
		if (patterns.containsKey(patternString)) {
			...
			patterns.put(patternString, new Pair<String, List<RankListCellExpression>>(exampleString,
					matchedExpressions));
		}
	}
	...
	private static Pattern regexExpression = Pattern.compile("([\\$\\^\\|\\[\\]\\{\\}\\(\\)\\.\\*\\?\\+\\\\])");
	private static Pattern numberic = Pattern.compile("\\d+");

	public static String getPattern(String str) {
		return numberic.matcher(regexExpression.matcher(str).replaceAll("\\\\$1")).replaceAll("(\\\\d+)");
	}

	public static List<Integer> getValues(String cellString){
